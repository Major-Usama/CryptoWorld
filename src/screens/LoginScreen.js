...
function LoginScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={{ ...styles.login, color: "#137383", fontSize: 30 }}>
        Log In
      </Text>
      <View style={{ ...styles.form, marginTop: "30%" }}>
        ...
        <TouchableWithoutFeedback
          ...
          //   onPress={Alert.alert('An Email is sent to you to recover your password')}
        >
          <Text style={{ fontWeight: "bold", color: "#137383" }}>
            Forgot Password ?
          </Text>
        </TouchableWithoutFeedback>
