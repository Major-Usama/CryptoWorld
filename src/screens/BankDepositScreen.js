        ...
        >
          ...
          <View style={{ marginLeft: wp("10%") }}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              />
              <Text style={{ fontSize: 12, color: "gray", opacity: 0.7 }}>
                Balance : United States Dollar{" "}
              </Text>
            </View>
          </View>
        ...
        >
          ...
          >
            ...
            <Text style={{ fontWeight: "bold", marginLeft: 10 }}>
              Recent <Text style={{ fontWeight: "normal" }}>Transactions</Text>
            </Text>
          </View>

          <View>
            <Text style={{ fontWeight: "bold", color: "gray", opacity: 0.7 }}>
              VIEW ALL{" "}
            </Text>
            <Text
              style={{
